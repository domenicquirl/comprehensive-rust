...
- [Pattern Matching](pattern-matching.md)
  ...
  - [Let Control Flow](pattern-matching/let-control-flow.md)
    - [`if let`](pattern-matching/let-control-flow/if-let.md)
    - [`let else`](pattern-matching/let-control-flow/let-else.md)
    - [`while let`](pattern-matching/let-control-flow/while-let.md)
...
- [Error Handling](error-handling.md)
  ...
  - [`Error` Trait and `dyn Error`](error-handling/error.md)
...
- [Unsafe Rust](unsafe-rust.md)
  ...
  - [Unsafe Functions](unsafe-rust/unsafe-functions.md)
    - [Extern Function FFI](unsafe-rust/unsafe-functions/ffi.md)
    - [Writing Unsafe Functions](unsafe-rust/unsafe-functions/writing.md)
